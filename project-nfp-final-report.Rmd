...
plot.ts(nfp_nsa_ts, main = "Nonfarm Payrolls 1939-2018", xlab = "Months (since January 1939)", ylab = "Number of Payrolls", cex.main=0.7, cex.lab=0.5, cex.axis=0.3)
plot.ts(nfp_nsa_ts_2010_2018, main = "Nonfarm Payrolls 2010-2018", xlab = "Months (since January 2010)", ylab = "Number of Payrolls", cex.main=0.7, cex.lab=0.5, cex.axis=0.3)
```
...
```{r fig.align='center', fig.height = 2.5, echo=FALSE}
