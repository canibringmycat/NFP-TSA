...
```{r fig.align='center', fig.height = 2.7, echo=FALSE}
par(mfrow=c(1,2))
acf(NSA_sdiff2, main = "ACF", cex.main=0.6)
pacf(NSA_sdiff2, main = "PACF", cex.main=0.6)
```
...
ts.plot(nfp_nsa_training_ts, forecast$pred, col=c("black", "red"), ylab = "Total Payrolls", main = "ARIMA Model Forecast", cex.main=0.8, cex.lab=0.5, cex.axis=0.3)
